...
namespace MySqlDAL
{
    public class DBHelperMySQL
    {
       ...
       // public static string connectionString = ConfigurationManager.ConnectionStrings["haqiuConnectionString"].ConnectionString;
        ...
        /// <param name="SQLString">查询语句</param>
        /// <returns>DataSet</returns>
        public static DataSet PageQuery(string SQLString, int PageIndex, int PageSize, params MySqlParameter[] cmdParms)
        {
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                MySqlCommand cmd = new MySqlCommand();
        ...
        private static MySqlCommand BuildIntCommand(MySqlConnection connection, string storedProcName, IDataParameter[] parameters)
        {
            ...
            //    MySqlDbType.Int32, ParameterDirection.ReturnValue,
        ...
        public static DataSet PagedataSet(string SQLString, int PageIndex, int PageSize, string table)
        {
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                MySqlCommand cmd = new MySqlCommand();
