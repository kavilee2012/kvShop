<%@ Page Language="C#" MasterPageFile="~/aadmin/mu.master" AutoEventWireup="true" CodeFile="newsselect.aspx.cs" Inherits="admin_newselect" Title="新闻搜索 %>
   ...
   <div style=" text-align:right; padding-right:52px;">  
    ...
    <div style="margin-top:13px;">
        ...
        　<webdiyer:AspNetPager ID="AspNetPager1" runat="server" FirstPageText="首页" 
            ...
            onpagechanging="AspNetPager1_PageChanging1" PrevPageText="上一页">
